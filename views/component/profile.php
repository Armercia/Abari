      ...
      <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
        ...
        <div class="sm:col-span-9">
          <div class="flex items-center gap-5">
            <img class="inline-block size-16 rounded-full ring-2 ring-white" src="<?php echo $_SESSION['user']['user_img_url'] ?? $_SESSION["user"][0]["user_img_url"]?>" id="priviewImg"
              alt="Image Description">
            <div class="flex gap-x-2">
              <div>
                <input type="file" value="<?php echo $_SESSION['user']['user_img_url']  ?? $_SESSION["user"][0]["user_img_url"]?>" name="file" id="fileInput">
        ...
        <div class="sm:col-span-9">
          <input id="af-account-full-name" name="username" value="<?php echo $_SESSION['user']['username'] ?? $_SESSION["user"][0]["username"]?>" type="text"
        ...
        <div class="sm:col-span-9">
          <input id="af-account-email" name="email" value="<?php echo $_SESSION['user']['email'] ?? $_SESSION["user"][0]["email"]?>" type="email"
            class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
 ...
 End Col -->
        ...
        <div class="sm:col-span-9">
          <textarea id="af-account-bio" name="bio"
            ...
            rows="6" placeholder="Type your message..."><?php echo $_SESSION['user']['bio'] ?? $_SESSION["user"][0]["bio"]?></textarea>
        </div>
        <!-- End Col -->
      </div>
      <!-- End Grid -->

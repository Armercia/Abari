...
<div id="application-sidebar" class="hs-overlay [--auto-close:lg]
 ...
 ">
    <div class="px-8 pt-4">
        <!-- Logo -->
        <a class="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="/resit" aria-label="Preline">
            Abari
        </a>
        <!-- End Logo -->
    </div>
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        <ul class="space-y-1.5">
            ...
            <?php if (isset($_SESSION['user']) && isset($_SESSION['user']['user_type'])) : ?>
                <?php if ($_SESSION['user']['user_type'] !== 'voter') : ?>
            <li>
